...
<c:if test="${not empty comments}">
				<c:forEach var="comment.parentCommentId == param.commentId">
							<c:if test="${comment.parentCommentId == param.commentId}">
												<div style="margin-left: 20px;">
														...
														<p id="commentContent_${ comment.commentId}" style="display:none;">
														<!--  댓들 수정 폼 -->
														...
														<div id="replyForm_${comment.commentId}" style="display:none' margin-left:	20px;">
																	<textarea id="replyContens_${comment.commentId}" rows="3" placeholder="답글을 입력하세요...."></textarea>
